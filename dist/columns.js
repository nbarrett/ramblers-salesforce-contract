export const INSIGHT_HUB_COLUMNS = [
...
const HEADER_LOOKUP = Object.fromEntries(INSIGHT_HUB_COLUMNS.map((c) => [normaliseHeader(c.header), c]));
export function findColumn(headerText) {
