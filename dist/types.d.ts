export type MembershipStatus = "Active" | "Payment pending" | "Suspended" | "Lapsed" | "Inactive" | "Resigned";
export type MemberType = "Corporate Membership" | "Individual Life Membership" | "Individual Membership" | "Joint Life Membership" | "Joint Membership" | "Membership";
...
export type SupporterUpdateErrorType = "Email not recognised for this group" | "Invalid email" | "System unavilable" | "Required field missing";
